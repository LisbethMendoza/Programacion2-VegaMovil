...
namespace CapaDatosVentas_Vehiculos
{
    public class CDClient
    {
        ...
        public CDClient(int pidcliente,string pnombre_cliente ,string ptipo_documento, string pdocumento, string pdireccion, string ptelefono, string pmovil, string pestado)
        {
        ...
        public string Insertar(CDClient objCliente)
        {
            string mensaje = "";
        ...
        public string Actualizar(CDClient objCliente)
        {
            string mensaje = "";
            //creamos un nuevo objeto de tipo SqlConnection
            SqlConnection sqlCon = new SqlConnection();
